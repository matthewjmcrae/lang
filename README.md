...
Passing examples live in `examples/basic` (79 programs).

Negative type-checking examples live in `examples/invalid` (45 programs).
...
- indexed array assignment (`a[i] = …` not yet supported)
- structs or classes
- imports or modules
- generics
- container stdlib
